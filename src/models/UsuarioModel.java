...
public class UsuarioModel {
	...
	/**
	 * 
	 * Pega do banco de dados o usuario atrav�s o ID passado
	 * @param idUsuario = Id do usuario
	 * 
	 * @throws SQLException = Caso nao exista no banco ir� soltar uma exception
	 */
	...
	public StatusMethod ativarUsuario(String codigoAtivacao) {
		...
		if (this.ativo) {
			...
			statusMethod.setTitulo("Usuario j� estava ativo");
			statusMethod.setMensagem("Esse usu�rio j� foi ativo anteriormente.");
			...
			statusMethod.setTitulo("C�digo inv�lido");
			statusMethod.setMensagem("O c�digo passado est� inv�lido");
		}
	...
	public void enviarEmailDeAtivacao() {
		...
		EnviarEmail.enviarEmailAtravesDoGoogle(this.email, "Link para ativa��o da conta", link);
	}
